...
namespace BobbyBoy
{
    ...
    string time = DateTime.Now.ToString("hh:mm tt");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            commands.Add(new string[] { "Hello", "I'm good", "How are you", "Bob", "Why is dad so annoying", "Why can't everyone be as awesome as me", "Whats my name", "What are you", "Who is the worst", "Who are you", "What's the time", "Open Google", "Will Hellewell", "Why are you so dumb", "Say hello to Eloise", "Isn't it bob", "What songs playing", "Close Google", "Open Steam", "Close Steam" });
